...
Prometheus is stateful and does not allow to replicate its database. This means that increasing high availability by just running multiple replicas of Prometheus is not easy.

TODO: finish.

## Metric Query Flow Overview

![Querier](../img/querier.svg)
